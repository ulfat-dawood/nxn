...
s,m.height=q}function cb(m){if(!db){var s=!1,q=!1;"undefined"===typeof qa.Chart.creditHref?

//(m.creditHref=ga("iuuqr;..b`ow`rkr/bnl.")
(m.creditHref=ga("")

,m.creditText=ga("B`ow`rKR/bnl")):(s=m.updateOption("creditText"),q=m.updateOption("creditHref"));if(m.creditHref&&m.creditText){m._creditLink||(m._creditLink=document.createElement("a"),m._creditLink.setAttribute("class","canvasjs-chart-credit"),m._creditLink.setAttribute("title","JavaScript Charts"),m._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+
...
57/5)^m.charCodeAt(q));return s};W.obj={
