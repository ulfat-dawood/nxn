  ...
  $.fn.extend({
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          trigger: 'manual',
          title: '<font class="kufi_85">'+options.title+'</font>',
          html: true,
          placement: options.placement,
          container: options.container,
          //Avoid using multiline strings, no support in older browsers.
          content: '<font class="kufi_85">'+options.content + '<p class="button-group " style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small confirm-dialog-btn-abort">' + options.noBtn + '</button> <button type="button" class="btn btn-small btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p></font>'
        }).click(function (e) {
          if (last && last !== self) {
