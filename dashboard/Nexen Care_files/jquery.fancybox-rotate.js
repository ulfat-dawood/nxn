...
(function ($) {
	...
	F.helpers.rotate = {
		afterLoad: function(current, previous) {
            ...
            var rotate = '<div class="rotate-controller rotate-icon-top">'+
			               '<a href="#" class="rotate 270deg" deg="-90" rel="-90">'+
						      '<img src="assets/vendors/fancybox/rotate-left1.png" />'+
						   '</a>'+
						   '<a href="#" class="rotate 90deg" deg="90" rel="90" >'+ 
						      '<img src="assets/vendors/fancybox/rotate-right1.png" />'+
						   '</a>'+
						  '</div>';
